...
if (empty($_POST['beat_check']) || empty($selectedDate)){
    echo "<script>window.location = '".url_path('/staff/generate-guards-absentee-report',true,true)."';</script>";
}
    ?>
    <section role="main" class="mx-5">
        <div class="d-flex justify-content-center mb">
            <div>
                <a href="<?= url_path('/staff/generate-guards-absentee-report',true,true)?>">
        ...
        <div class="card mt-2">
            <header class="card-header">
                <a style="float:left;" href="<?= url_path('/staff/generate-guards-absentee-report',true,true)?>" class="no_style">
