...
<?php
if (!isset($guard_id) || $guard_id == NULL ) {echo "<script>window.location = '".url_path('/staff/list-guards',true,true)."'; </script>";}
?>
<?php
            ...
            <header class="page-header">
                ...
                <div class="right-wrapper text-end">
                    <ol class="breadcrumbs">
                        ...
                        <li><span><a href="<?= url_path('/staff/list-guards',true,true)?>">Guard List</a></span></li>
                        ...
                        <div class="card-body">
                            <div class="content">
                                <ul class="simple-user-list">
                                    <li>
                                        <a href="<?= url_path('/staff/print-guard-profile/'.$guard_id,true,true);?>">
                                    ...
                                    <li>
                                        ...
                                        if($deployed_guard->num_rows == 0){
                                            ?>
                                            <a class="" href="<?= url_path('/staff/deploy-guard-in-profile/'.$row['guard_id'],true,true);?>">
                                        ...
                                        <?php }else{?>
                                            <a class="" href="<?= url_path('/staff/edit-norminal-roll/'.$row['guard_id'],true,true);?>">
                                                <figure class="image rounded">
                                                    <i class="fas fa-reply"></i>
                                                </figure>
                                    ...
                                    <hr class="dotted short">
                                    <!--                                    <li>-->
                                    <!--                                        <a class="modal-with-move-anim ws-normal" href="#">-->
                                    <!--                                            <figure class="image rounded">-->
                                    <!--                                                <i class="fa fa-id-card margin"></i>-->
                                    <!--                                            </figure>-->
                                    <!--                                            <span class="title">Generate ID Card</span>-->
                                    <!--                                        </a>-->
                                    <!--                                    </li>-->
                                    <!--                                    <hr class="dotted short">-->
                                    <!--<li>-->
                                    ...
                                    <hr class="dotted short">
                                    <li>
                                        <a href="<?= url_path('/staff/guard-activity-log/'.$guard_id,true,true);?>">
                ...
                <div class="col-lg-8 col-xl-8">
                    <div class="tabs">
                        <ul class="nav nav-tabs">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" data-bs-target="#sectionThree" href="#sectionThree" data-bs-toggle="tab">Guard Bank and Official Info</a>
                            </li>
                            <li class="nav-item">
...
<script>
    $('#propicxUpload').click(function(){ $('#guard_profile_picx_update').trigger('click'); });
</script>
