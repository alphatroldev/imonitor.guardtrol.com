                ...
                <section class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="mb-3">
                                    <a href="<?= url_path('/staff/incident',true,true)?>" class="btn btn-primary"><i class="fas fa-plus">&nbsp;&nbsp;</i>Report Incident</a>
                                </div>
                            </div>
                        </div>
                            ...
                            if ($res->num_rows > 0) {$n=0;
                                while ($row = $res->fetch_assoc()) {
                                    ...
                                    <tr>
                                        ...
                                        <td data-title="View"><a class="btn btn-default btn-xs" href="<?= url_path('/staff/incidents/'.$row['inc_rep_id'],true, true);?>">view more</a></td>
