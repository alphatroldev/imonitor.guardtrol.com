                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-6 mb-3">
                                <a href="<?= url_path('/staff/staff-offenses',true,true)?>" class="btn btn-success"><i class="fas fa-list-alt">&nbsp;&nbsp;</i>Staff Offence</a>
                                <a href="<?= url_path('/staff/staff-pardon-history',true,true)?>" class="btn btn-primary"><i class="fas fa-list">&nbsp;&nbsp;</i>Staff Pardon History</a>
                            </div>
                        </div>
