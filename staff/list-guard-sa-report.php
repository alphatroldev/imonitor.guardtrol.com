            ...
            <section class="card">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="mb-3">
                                <a href="<?= url_path('/staff/generate-salary-advance-report',true,true)?>" class="btn btn-primary"><i class="fas fa-plus">&nbsp;&nbsp;</i>Generate Guard S.A Report</a>
                            </div>
                        </div>
                    </div>
                    <table class="table table-bordered table-striped mb-0" id="datatable-company">
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <a href="<?= url_path('/staff/guard-salary-advance-report-details/'.$row['sa_rh_month'].'-'.$row['sa_rh_year'],true,true)?>"
