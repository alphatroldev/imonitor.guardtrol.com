                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-6 mb-3">
                                <a href="<?= url_path('/staff/guard-offenses',true,true)?>" class="btn btn-success"><i class="fas fa-list">&nbsp;&nbsp;</i>Guard Offence</a>
                                <a href="<?= url_path('/staff/guard-pardon-history',true,true)?>" class="btn btn-primary"><i class="fas fa-list-alt">&nbsp;&nbsp;</i>Guard Pardon History</a>
                            </div>
                        </div>
                            ...
                            if ($res->num_rows > 0) {$n=0;
                                while ($grd_offence = $res->fetch_assoc()) {
                                    ...
                                    <tr>
                                        ...
                                        <td data-title="Charge/Penalties"><?= $grd_offence['no_of_days'];?></td>
                                        ...
                                        <td data-title="Remark"><?= $grd_offence['offense_remark'];?></td>
                                        <td data-title="Date issued"><?=  date("d/m/Y", strtotime($grd_offence['created_at']));?></td>
