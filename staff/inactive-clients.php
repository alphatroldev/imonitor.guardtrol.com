        ...
        <header class="page-header">
            ...
            <div class="right-wrapper text-end">
                <ol class="breadcrumbs">
                    ...
                    <li><span><a href="<?= url_path('/staff/list-clients',true,true)?>">List Clients</a></span></li>
                ...
                <section class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="mb-3">
                                    <a href="<?= url_path('/staff/list-clients',true,true)?>" class="btn btn-success">Active Clients</a>
                                </div>
                            </div>
                        </div>
