            ...
            <header class="page-header">
                ...
                <div class="right-wrapper text-end">
                    <ol class="breadcrumbs">
                        ...
                        <li><span><a href="<?= url_path('/staff/list-clients',true,true)?>">Clients</a></span></li>
                        ...
                        <div class="card-body">
                            <div class="content">
                                <ul class="simple-user-list">
                                    <li>
                                        <a href="<?= url_path('/staff/print-client-profile/'.$row['client_id'],true,true);?>">
                                    ...
                                    <hr class="dotted short">
                                    <li>
                                        <a class="" href="<?= url_path('/staff/create-beat/'.$row['client_id'],true,true);?>">
                                    ...
                                    <hr class="dotted short">
                                    <li>
                                        <a href="<?= url_path('/staff/client-debtors-ledger/'.$client_id,true,true)?>">
                                            <figure class="image rounded"><i class="fas fa-money-check-alt"></i></figure>
                                            <span class="title">View Debtors Ledger</span>
                                        </a>
                                    </li>
                                    <hr class="dotted short">
                                    <li>
                                        <a href="<?= url_path('/staff/client-invoice-history/'.$client_id,true,true)?>">
                            ...
                            <div class="card-body">
                                <div class="modal-wrapper py-0">
                                    <div class="form-group border-0">
                                        ...
                                        <select data-plugin-selectTwo class="form-control populate placeholder" name="beat_id" id="beat_id">
                                            <option value=""></option>
                                            <?php
                                    ...
                                    <div class="form-group border-0">
                                        ...
                                        <textarea name="dc_reason" rows="5" id="dc_reason" class="form-control" placeholder="Reason/comment"></textarea>
                                            ...
                                            while ($row2 = $res2->fetch_assoc()) {
                                                ...
                                                <tr>
                                                   <td data-title="sno">#<?=++$n;?></td>
                                                    ...
                                                    <!--<td data-title="Credit Amt"><?= $row2['chr_days_amt'];?></td>-->
                                        ...
                                        <div class="form-group row pb-3">
                                            <div class="col-lg-12">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control mb-3" name="edit_client_status" title="Required" required>
                                                        <option value="Active" <?=($row['client_status']=='Active')?'selected':'';?>>Active</option>
                                                        <option value="Deactivate" <?=($row['client_status']=='Deactivate')?'selected':'';?>>Deactivate</option>
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <form name="update_client_contact_info" id="update_client_contact_info">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group row pb-3">
                                            <div class="col-lg-8">
                                                <div class="form-group">
                                                    <label class="col-form-label" for="">Client Representative Fullname 2</label>
                                            ...
                                            <div class="col-lg-4">
                                                <label class="col-form-label" for="">Client Representative Position 2<span class="required">*</span></label>
                                                <input class="form-control" name="edit_client_contact_position_2" title="Position 2" value="<?= $row['client_contact_position_2'];?>" />
                                            </div>
                                        </div>
                                        <div class="form-group row pb-3">
                                            <div class="col-lg-6">
                                    ...
                                    if ($res->num_rows > 0) {$n=0;
                                        while ($row = $res->fetch_assoc()) {
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="<?= url_path('/staff/beat-activity-log/'.$row['beat_id'],true,true);?>"
                                                       style="font-size: 11px" class="btn btn-xm btn-default px-2 py-1"> <i class="bx bx-book-alt">&nbsp;</i>view log
                                                    </a>
                                                </td>
                                                <td class="actions">
                                                    <a href="<?= url_path('/staff/edit-beat/'.$row['beat_id'],true,true);?>" class="on-default edit-row"><i class="fas fa-pencil-alt"></i></a>
