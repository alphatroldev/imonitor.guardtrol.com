                ...
                <section class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="mb-3">
                                    <a href="<?= url_path('/staff/add-kit',true,true);?>" class="btn btn-primary pr-3"><i class="fas fa-plus">&nbsp;&nbsp;</i>Add Kit</a>
                                    ...
                                    <tr>
                                        ...
                                        <td data-title="Actions" class="actions">
                                            <a href="#editKitInvModal" class="on-default edit-row edit-kit-modal text-success mr-3" id="edit_kit_inventory"
                                               data-kit_inv_sno="<?= $row['kit_inv_sno'];?>" data-kit_qty="<?= $row['kit_number'];?>" data-kit_type="<?= $row['kit_type'];?>"
                                               data-kit_id="<?= $row['kit_sno'];?>" data-kit_name="<?= $row['kit_name'];?>">
