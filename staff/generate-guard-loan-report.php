        ...
        <div class="col-md-12">
            <section class="card card-featured card-featured-primary mb-4">
                <header class="card-header">
                    <h2 class="card-title">Generate Guard Loan Report</h2>
                </header>
                <div class="card-body">
                    <form action="Z2VuZXJhdGUtZ3VhcmQtbG9hbi1yZXBvcnQ=" method="post">
                        <div class="col-sm-7">
