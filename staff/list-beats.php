    ...
    <section role="main" class="content-body">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="mb-3">
                                    ...
                                    <a href="<?= url_path('/staff/inactive-beats',true,true)?>" class="btn btn-danger">Inactive Beats</a>
                                </div>
                            </div>
                        </div>
                        <table class="table table-bordered table-striped mb-0" id="datatable-staff" style="font-size: 11px">
                            <thead>
                            <tr>
                                <th>s/n</th>
                                <th>Client</th>
                                ...
                                while ($row = $res->fetch_assoc()) {
                                    ...
                                    <tr>
                                        ...
                                        <td><?= ($beat_personnel <= ($act_guard+$act_super))?
                                                '<a href="'. url_path('/staff/list-active-beat-guard/'.$row['beat_id'], true, true).'">
        ...
        <div id="changeStatus" class="zoom-anim-dialog modal-block modal-block-primary mfp-hide">
            <form name="changeBeatStat" id="changeBeatStat" class="card">
                <header class="card-header">
                    <h2 class="card-title">Change Status <small>(Disabling this beat also disables all guards attached to it)</small> </h2>
                </header>
                <div class="card-body">
