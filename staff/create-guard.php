            ...
            <form class="form-horizontal" name="register_guard" id="register_guard">
                <div class="tab-content">
                        ...
                        <div class="GuardReferralDiv">
                            ...
                            <div class="form-group row pb-3">
                                <div class="col-sm-6 GuardReferralDiv">
                                    ...
                                    <input type="text" class="form-control" name="referral_phone" id="w5-referral-phone">
                                </div>
                            ...
                            <div>
                                ...
                                <div class="form-group row pb-3">
                                    ...
                                    <div class="col-sm-4">
                                        ...
                                        <input type="text" class="form-control" name="guarantor_email[]" id="w5-guarantor-email-1" >
                                    </div>
                                    <div class="col-sm-3">
                                ...
                                <div class="form-group row pb-3">
                                    <div class="col-sm-4">
                                        <label class="control-label pt-1" for="w5-guarantor-photo-1">Guarantor Photo</label>
                                        <input type="file" class="form-control" name="guarantor_photo[]" id="w5-guarantor-photo-1" >
                                    </div>
                                    <div class="col-sm-8">
                                ...
                                <div class="form-group row pb-3">
                                    ...
                                    <div class="col-sm-4">
                                        <label class="control-label pt-1" for="w5-guarantor-ID-crd-frnt-1">ID Card Front</label>
                                        <input type="file" class="form-control" name="guarantor_crd_frnt[]" id="w5-guarantor-ID-crd-frnt-1" >
                                    </div>
                                    <div class="col-sm-4">
                                        <label class="control-label pt-1" for="w5-guarantor-Id-crd-bck-1">ID Card Back</label>
                                        <input type="file" class="form-control" name="guarantor_crd_bck[]" id="w5-guarantor-Id-crd-bck-1" >
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div id="w5-step-three" class="tab-pane p-3">
                        <div class="form-group row pb-3">
                            <div class="col-sm-6">
                                <label class="control-label pt-1" for="w5-guard-photo">Guard Photo<span class="required">*</span></label>
                                <input type="file" class="form-control" name="guard_photo" id="w5-guard-photo" required>
                            </div>
                            <div class="col-sm-6">
                        ...
                        <div class="form-group row pb-3">
                            <div class="col-sm-6">
                                <label class="control-label pt-1" for="w5-guard-ID-crd-frnt"> Guard ID Card Front<span class="required">*</span></label>
                                <input type="file" class="form-control" name="guard_crd_frnt" id="w5-guard-ID-crd-frnt" required>
                            </div>
                            <div class="col-sm-6">
                                <label class="control-label pt-1" for="w5-guard-Id-crd-bck"> Guard ID Card Back<span class="required">*</span></label>
                                <input type="file" class="form-control" name="guard_crd_bck" id="w5-guard-Id-crd-bck" required>
                            </div>
                        </div>
                        <div class="form-group row pb-3">
                            <div class="col-sm-4">
                        ...
                        <div class="form-group row pb-3">
                            ...
                            <div class="col-sm-7">
                                <label class="control-label pt-1" for="w5-guard-signature">Guard Signature<span class="required">*</span></label>
                                <input type="file" class="form-control" name="guard_signature" id="w5-guard-signature" required>
                            </div>
                        </div>
                        <div class="form-group row pb-3">
                            <label class="control-label pt-1" for="w5-guard-remark">Remark</label>
                            <div class="col-sm-12">
                                <input type="text" class="form-control" name="guard_remark" id="w5-guard-remark">
                            </div>
                        </div>
                    </div>
                </div>
        ...
        $(".content-body").on('click', '.add_more_guarantor_info', function (e) {
            ...
            if (count >3){
                ...
                $('.listing-more').append('<div style="border-top: 1px solid #ccc;margin-top:10px;" id="dynamic_field'+count+'">' +
                    ...
                    '<label class="control-label pt-1" for="w5-guarantor-photo-'+count+'">Guarantor Photo '+count+'</label>' +
                    '<input type="file" class="form-control" name="guarantor_photo[]" id="w5-guarantor-photo-'+count+'" >' +
                    ...
                    '<option value="National ID Card">National ID Card</option><option value="Valid Work ID Card">Valid Work ID Card</option></select></div><div class="col-sm-4">' +
                    '<label class="control-label pt-1" for="w5-guarantor-ID-crd-frnt-'+count+'">ID Card Front '+count+'</label>' +
                    '<input type="file" class="form-control" name="guarantor_crd_frnt[]" id="w5-guarantor-ID-crd-frnt-'+count+'" >' +
                    '</div><div class="col-sm-4"><label class="control-label pt-1" for="w5-guarantor-Id-crd-bck-'+count+'">ID Card Back '+count+'</label>' +
                    '<input type="file" class="form-control" name="guarantor_crd_bck[]" id="w5-guarantor-Id-crd-bck-'+count+'" >' +
                    '</div></div>' +
