...
if (!isset($mon_year) || $mon_year==''){
    echo "<script>window.location = '".url_path('/staff/generate-salary-advance-report',true,true)."';</script>";
} else {
...
<section role="main" class="mx-5">
    <div class="d-flex justify-content-center mb">
        <div>
            <a href="<?= url_path('/staff/list-guard-sa-report',true,true)?>">
        ...
        <div class="px-3">
            <h2 class="text-center text-uppercase">
                <a href="<?= url_path('/staff/list-guard-sa-report',true,true)?>"><?=$c['company_name'];?> GUARD SALARY ADVANCE REPORT (I.O.U)</a>
            </h2>
        </div>
    </div>
    <div class="card mt-2">
