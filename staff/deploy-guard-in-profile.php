        ...
        <header class="page-header">
            ...
            <div class="right-wrapper text-end">
                <ol class="breadcrumbs">
                    ...
                    <li><a href="<?= url_path('/staff/list-guards',true,true)?>">Guard List</a></li>
                    <li><a href="<?= url_path('/staff/edit-guard/'.$guard_id,true,true)?>">
                            <?= $row['guard_firstname']." ".$row['guard_lastname'];?></a>
                    </li>
