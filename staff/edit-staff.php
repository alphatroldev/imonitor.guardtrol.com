    ...
    while ($row = $res->fetch_assoc()) {
        ...
        <section role="main" class="content-body">
            <header class="page-header">
                <h2><a href="<?= url_path('/staff/list-staffs',true,true)?>"><i class="fas fa-arrow-left">&nbsp;</i></a>Edit Staff</h2>
                <div class="right-wrapper text-end">
                    <ol class="breadcrumbs">
                        <li>
                            <a href="<?= url_path('/staff/main',true,true)?>"><i class="bx bx-home-alt"></i></a>
                        </li>
            ...
            <div class="row">
                <div class="col-lg-4 col-xl-4 mb-4 mb-xl-0">
                        ...
                        <div class="card-body">
                            <div class="content">
                                <ul class="simple-user-list">
                                    <li>
                                        <a href="<?= url_path('/staff/print-staff-profile/'.$row['staff_id'],true,true);?>">
                                    ...
                                    <hr class="dotted short">
                                    <li>
                                        <a href="<?= url_path('/staff/staff-activity-log/'.$staff_id,true,true);?>">
                    ...
                    <!-- Edit Privilege Animation-->
                    <div id="editPrivilege" class="zoom-anim-dialog modal-block modal-block-primary mfp-hide">
                        <section class="card">
                            <header class="card-header">
                                <h2 class="card-title">Edit Privilege</h2>
                            </header>
                            <div class="card-body">
                                <div class="modal-wrapper py-0">
