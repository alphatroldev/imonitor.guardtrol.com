...
<section role="main" class="content-body">
    <header class="page-header">
        <h2>Generate Uniform Deduction Report</h2>
        <div class="right-wrapper text-end">
            <ol class="breadcrumbs">
                <li><a href="<?= url_path('/staff/main',true,true)?>"><i class="bx bx-home-alt"></i></a></li>
                <li><span>Generate Uniform Deduction Report</span></li>
            </ol>
        ...
        <div class="col-md-12">
            <section class="card card-featured card-featured-primary mb-4">
                <header class="card-header">
                    <h2 class="card-title">Guard Uniform Deduction Report</h2>
                </header>
                <div class="card-body">
                    <form action="Z2VuZXJhdGUtdW5pZm9ybS1kZWR1Y3Rpb24tcmVwb3J0" method="post">
                        <div class="col-sm-7">
