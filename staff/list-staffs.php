...
<?php if(!in_array($view_staff_permission_sno['perm_sno'], $array))header("Location:".$location_redirect);?>
                ...
                <section class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="mb-3">
                                    <a href="<?= url_path('/staff/add-staff',true,true)?>" class="btn btn-primary"><i class="fas fa-plus">&nbsp;&nbsp;</i>Add New Staff</a>
                                </div>
                            </div>
                        </div>
                            ...
                            if ($res->num_rows > 0) {$n=0;
                                while ($row = $res->fetch_assoc()) {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?= url_path('/staff/edit-staff/'.$row['staff_id'],true,true)?>" class="btn btn-xs btn-default"><i class="fas fa-pencil-alt">&nbsp;</i>view more</a>
                                            <a href="<?= url_path('/staff/staff-activity-log/'.$row['staff_id'],true,true);?>" class="on-default remove-row ml-2">
