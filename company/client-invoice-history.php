...
if (!isset($client_id) || $client_id == NULL ) {
    echo "<script>window.location = '".url_path('/company/list-clients',true,true)."'; </script>";
}
?>
<?php
...
<section role="main" class="content-body">
    <header class="page-header">
        <h2>
            <a href="<?= url_path('/company/edit-client/'.$client_id,true,true)?>"><i class="fas fa-arrow-left">&nbsp;&nbsp;</i></a>
            Invoice History
        </h2>
                        ...
                        if ($history->num_rows > 0) {$n=0;
                            while ($his = $history->fetch_assoc()) {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?= url_path('/company/invoice-preview/'.$his['client_id'].'/'.$his['invoice_id'],true,true)?>"
