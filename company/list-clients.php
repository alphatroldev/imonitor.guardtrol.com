                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-12 pb-3">
                                <a href="<?= url_path('/company/create-client',true,true)?>" class="btn btn-primary"><i class="fas fa-plus">&nbsp;&nbsp;</i>Register Client</a>
                                <a href="<?= url_path('/company/inactive-clients',true,true)?>" class="btn btn-danger ml-2">Inactive Clients</a>
                            </div>
                        </div>
                            ...
                            if ($res->num_rows > 0) {$n=0;
                                while ($row = $res->fetch_assoc()) {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?= url_path('/company/edit-client/'.$row['client_id'],true,true)?>"
                                        ...
                                        <td class="actions">
                                            ...
                                            <?php if ($row['client_status'] =='Active'){ ?>
                                                <a data-client_id="<?=$row['client_id'];?>" data-client_status="<?=$row['client_status'];?>" title="Deactivate client"
                                                   class="modal-with-move-anim ws-normal btn btn-xs text-white btn-danger" href="#changeStatus" id="clientStatusBtn">
                                                    Disable
                                                </a>
                                            <?php } else { ?>
                                                <a data-client_id="<?=$row['client_id'];?>" data-client_status="<?=$row['client_status'];?>" title="Activate client"
                                                   class="modal-with-move-anim ws-normal  btn btn-xs text-white btn-success" href="#changeStatus" id="clientStatusBtn">
                                                    Activate
                                                </a>
                                            <?php } ?>
                                        </td>
            ...
            <form name="changeClientStatus" id="changeClientStatus" class="card">
                ...
                <div class="card-body">
                    <div class="modal-wrapper py-0">
                        ...
                        <div class="form-group">
                            <label for="">Contract Terminated On</label>
