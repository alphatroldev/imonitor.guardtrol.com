...
<?php
if (!isset($guard_id) ||$guard_id == NULL ) {echo "<script>window.location = '".url_path('/company/list-beats',true,true)."'; </script>";}
        ...
        <header class="page-header">
            ...
            <div class="right-wrapper text-end">
                <ol class="breadcrumbs">
                    ...
                    <li><span><a href="<?= url_path('/company/list-norminal-rolls',true,true)?>">Norminal Rolls</a></span></li>
                    ...
                    <div class="tabs">
                        ...
                        <div class="tab-content">
                            ...
                            <div class="form-group row pb-3">
                                ...
                                <?php if($row['paid_observation'] == "yes"){ ?>
                                <div class="col-sm-6 row_chr_days">
                                    <div class="form-group">
                                  <label class="control-label pt-1" for="">No of Observation Days Worked<span class="required">*</span></label>
