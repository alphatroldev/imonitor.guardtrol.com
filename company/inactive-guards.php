            ...
            <div class="col">
                <section class="card">
                    <header class="card-header">
                        ...
                        <h2 class="card-title">Inactive Guards</h2>
                    </header>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="mb-3">
                                    <a href="<?= url_path('/company/list-guards',true,true)?>" class="btn btn-success">Active Guards</a>
                                </div>
                            </div>
                        </div>
                        <table class="table table-bordered table-striped mb-0" id="datatable-company">
                            ...
                            <tbody>
                            <?php
                            $res = $guard->get_inactive_guards($c['company_id']);
                            ...
                            if ($res->num_rows > 0) {$n=0;
                                ...
                                <?php } } else { echo "<tr><td colspan='12' class='text-center'>No inactive Guard</td></tr>";} ?>
                            </tbody>
                        </table>
                    </div>
                </section>
