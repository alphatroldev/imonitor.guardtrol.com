...
<?php
if (!isset($incident_id) || $incident_id == NULL ) {echo "<script>window.location = '".url_path('/company/incident',true, true)."'; </script>";}
?>
<?php
    ...
    while ($row = $res->fetch_assoc()) {
        ...
        <section role="main" class="content-body">
            <header class="page-header">
                <h2><a href="<?= url_path('/company/all-incident',true, true);?>"><i class="fas fa-arrow-left">&nbsp;&nbsp;</i></a>Incident Details</h2>
                        ...
                        <div class="row">
                            <div class="col-lg-4 col-xl-3 mb-4 mb-xl-0">
                                <section class="card">
                                    ...
                                    <div class="card-body">
                                        <div><a class="" href="<?= url_path('/company/all-incident',true, true);?>"><i class="fas fa-list-alt">&nbsp;</i>All Incidents</a></div>
                                    </div>
                                </section>
                                <section class="card">
                                    <header class="card-header">
                                    ...
                                    <div class="card-body">
                                        <div class="mb-2"><a href="<?= url_path('/company/main',true, true);?>"><i class="fas fa-home">&nbsp;</i>Dashboard</a></div>
                                        <div class="mb-2"><a href="<?= url_path('/company/list-staffs',true, true);?>"><i class="fas fa-user-friends">&nbsp;</i>Clients</a></div>
                                        <div class="mb-2"><a href="<?= url_path('/company/list-staffs',true, true);?>"><i class="fas fa-user-check">&nbsp;</i>Staffs</a></div>
                                    </div>
                                </section>
                            </div>
