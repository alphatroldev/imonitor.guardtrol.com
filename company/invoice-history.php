                    ...
                    <table class="table table-bordered table-striped mb-0" id="datatable-tabletools">
                        ...
                        ?>
                            <tr>
                                ...
                                <td class="no-print"><?= ($row['invoice_status']=="Paid")?"<span class='badge badge-success'>Paid</span>":
                                        "<span class='badge badge-danger'>Pending</span>";?></td>
                                <td class="no-print">
                                    <a href="<?= url_path('/company/invoice-history-details/'.$row['invoice_id'],true,true)?>"
                                       class="btn btn-xs btn-default"><i class="fas fa-pencil-alt">&nbsp;</i>view beats
                                    </a>
                                </td>
                                <td class="no-print">
                                    <a href="<?= url_path('/company/invoice-preview/'.$row['client_id'].'/'.$row['invoice_id'],true,true)?>"
