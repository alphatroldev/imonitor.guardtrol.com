            ...
            <div class="col">
                <section class="card">
                    <header class="card-header">
                        ...
                        <h2 class="card-title">Beat Guard Payroll History</h2>
                    </header>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="mb-3">
                                    <a href="<?= url_path('/company/create-guard-payroll',true,true)?>" class="btn btn-primary"><i class="fas fa-plus">&nbsp;&nbsp;</i>Generate Beat Guard Payroll</a>
                                </div>
                            </div>
                        </div>
                            ...
                            if ($res->num_rows > 0) {$n=0;
                                while ($row = $res->fetch_assoc()) {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?= url_path('/company/beat-guard-payroll/'.$row['gpr_month'].'-'.$row['gpr_year'],true,true)?>"
                                ...
                                <?php } } else { echo "<tr><td colspan='12' class='text-center'>No beat guard payroll history found</td></tr>";} ?>
                            </tbody>
                        </table>
                    </div>
                </section>
