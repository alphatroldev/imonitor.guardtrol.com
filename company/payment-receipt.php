...
if (!isset($receipt_id) || $receipt_id == NULL ) {
    echo "<script>window.location = '".url_path('/company/payment-report',true,true)."'; </script>";
}
?>
<section role="main" class="content-body">
    <header class="page-header">
        <h2>
            <a href="<?= url_path('/company/payment-report',true,true)?>"><i class="fas fa-arrow-left">&nbsp;&nbsp;</i></a>
            Payment Receipt
        </h2>
            ...
            <div class="invoice">
                ...
                <div class="invoice-summary">
                    <div class="row justify-content-end">
                        <div class="col-sm-4">
                            <p class="h5 mb-1 text-danger font-weight-semibold pb-3">Amount Paid: ₦ <?=number_format($receipt['amount'],2);?></p>
                ...
                <div class="d-grid gap-3 d-md-flex justify-content-md-end me-4">
                    <a href="<?=url_path('/company/payment-receipt-preview/'.$receipt['receipt_id'],true,true)?>" target="_blank"
