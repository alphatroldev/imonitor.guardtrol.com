...
if (empty($_POST['beat_check']) || empty($dates)){
    echo "<script>window.location = '".url_path('/company/generate-guard-clock-in-out-report',true,true)."';</script>";
} else {
...
<section role="main" class="mx-5">
    <div class="d-flex justify-content-center mb">
        <div>
            <a href="<?= url_path('/company/generate-guard-clock-in-out-report',true,true)?>">
    ...
    <div class="card mt-2">
        <header class="card-header">
            <h2 class="card-title text-center text-uppercase">
                <a style="float: left;" href="<?= url_path('/company/generate-guard-clock-in-out-report',true,true)?>" class="no_style">
