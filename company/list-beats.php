                ...
                <section class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="mb-3">
<!--                                    <a href="--><?//= url_path('/company/create-beat',true,true)?><!--" class="btn btn-primary"><i class="fas fa-plus">&nbsp;&nbsp;</i>Create New Beat</a>-->
                                    <a href="<?= url_path('/company/inactive-beats',true,true)?>" class="btn btn-danger">Inactive Beats</a>
                                </div>
                            </div>
                        </div>
