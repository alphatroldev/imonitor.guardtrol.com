                                ...
                                <div class="widget-summary">
                                    ...
                                    <div class="widget-summary-col">
                                        <div class="summary">
                                            ...
                                            <strong class="amount"><?=$supervisor->count_supervisor_total_guard($comp_id,$bsu_beats)?></strong>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="widget-summary">
                                    ...
                                    <div class="widget-summary-col">
                                        <div class="summary">
                                            ...
                                            <div class="info">
                                                <strong class="amount"><?=$supervisor->count_supervisor_total_clock_in_this_month($comp_id,$bsu_beats)?></strong>
                                            </div>
                                        </div>
                                        <div class="summary-footer">
                        ...
                        <section class="card card-featured card-featured-info mb-4">
                            <div class="card-body">
                                <div style="display: flex; justify-content: space-between; margin-bottom: 15px;">
                                    ...
                                    <div>
                                        <a href="<?= url_path('/supervisor/routing-clock',true,true)?>" class="btn btn-default btn-sm">Filter with date</a>
                                    </div>
                                </div>
                                <div>
