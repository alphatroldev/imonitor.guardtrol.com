                            ...
                            <div class="widget-summary">
                                ...
                                <div class="widget-summary-col">
                                    <div class="summary">
                                        ...
                                        <div class="info">
                                            <strong class="amount"><?= $supervisor->count_supervisor_total_complete_route_today($comp_id,$bsu_beats); ?></strong>
                                        </div>
                                    </div>
                            ...
                            <div class="widget-summary">
                                ...
                                <div class="widget-summary-col">
                                    <div class="summary">
                                        ...
                                        <div class="info">
                                            <strong class="amount"><?= $supervisor->count_supervisor_total_incomplete_route_today($comp_id,$bsu_beats); ?></strong>
                                        </div>
                                    </div>
                                    <div class="summary-footer">
                                        <a class="text-dark" href="javascript:void(0)">Today's Date: <b><?=date("d/M/Y");?></b></a>
