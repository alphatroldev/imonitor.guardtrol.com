...
include_once("controllers/classes/Client.class.php");
                ...
                <div class="col-md-6 col-lg-6">
                    <div class="row">
                        <div class="col-md-12 align-self-center p-static order-2 text-center">
                            <h1 class="font-weight-bold text-dark">Client Sign In</h1>
                        </div>
                    </div>
                    <div class="tabs">
                        <div class="tab-content p-lg-5 p-3">
                            <div id="owner_login" class="tab-pane active">
                                <form id="client_login" name="client_login">
...
<script src=<?= public_path("js/views/view.client.js"); ?>></script>
<script>
