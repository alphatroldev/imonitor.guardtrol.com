                                ...
                                <nav class="header-nav-top">
                                    <ul class="nav nav-pills text-uppercase text-2">
                                        <li class="nav-item nav-item-anim-icon d-none d-md-block">
                                            <a class="nav-link ps-0" href="https://alphatrol.com/guardtrol/"><i class="fas fa-angle-right"></i> About Us</a>
                                        </li>
                                        <li class="nav-item nav-item-anim-icon d-none d-md-block">
                                            <a class="nav-link" href="https://alphatrol.com/contact us"><i class="fas fa-angle-right"></i> Contact Support</a>
                                        </li>
                                    </ul>
                                </nav>
                            </div>
                    ...
                    <div class="tabs">
                        <div class="tab-content p-lg-5 p-3">
                            <div id="owner_login" class="tab-pane active">
                                <form id="create_company" name="create_company">
                                    <div id="response-alert"></div>
                                    <div class="row">
                                        <div class="form-group col">
                                            <label class="form-label text-color-dark text-3">Company Name <span class="text-color-danger">*</span></label>
                                            <input type="text" class="form-control shadow-none text-4" name="c_name"  required>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="form-group col">
                                            <label class="form-label text-color-dark text-3">Company Email <span class="text-color-danger">*</span></label>
                                            <input type="email" class="form-control shadow-none text-4" name="c_email"  required>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="form-group col">
                                            <label class="form-label text-color-dark text-3">Company Phone Number <span class="text-color-danger">*</span></label>
                                            <input type="text" class="form-control shadow-none text-4" name="c_phone" maxlength="11" required>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="form-group col">
                                            <label class="form-label text-color-dark text-3">Company Address <span class="text-color-danger">*</span></label>
                                            <input type="text" class="form-control shadow-none text-4" name="c_address"  required>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="form-group col">
                                            <label class="form-label text-color-dark text-3">Registration No <span class="text-color-danger">*</span></label>
                                            <input type="text" class="form-control shadow-none text-4" name="c_reg_no"  required>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="form-group col">
                                    ...
                                    <div class="row">
                                        <div class="form-group col">
                                            ...
                                            <input type="password" class="form-control shadow-none text-4" name="confirm_password"  required>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="form-group col">
                                            <label class="form-label text-color-dark text-3">Company Logo <span class="text-color-danger">(optional)</span></label>
                                            <input type="file" class="form-control shadow-none text-4" name="c_logo">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="form-group col mt-3">
                                            <input type="submit" value="Register" class="btn btn-primary-scale-2 btn-modern w-100 text-uppercase rounded-0 font-weight-bold text-3 py-3" data-loading-text="Please wait..." />
                                        </div>
                                    </div>
                                    <div class="divider">
                                    ...
                                    <div class="row">
                                        <div class="form-group col">
                                            <a href="./" class="btn btn-dark btn-modern w-100 text-uppercase rounded-0 font-weight-bold text-3 py-3">Login</a>
                                        </div>
                                    </div>
                                </form>
                            </div>
